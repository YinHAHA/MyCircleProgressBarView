...
/**
 * Created by yinyun on 2018/9/27.
 */
...
public class CircleProgressBarView extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        progressColor = typedArray.getColor(R.styleable.CircleProgressBarView_progress_color,Color.GREEN);
        bgColor = typedArray.getColor(R.styleable.CircleProgressBarView_bg_color,Color.GRAY);
        ...
        barWidth = typedArray.getDimension(R.styleable.CircleProgressBarView_bar_width,dip2px(context,5));
        typedArray.recycle();
